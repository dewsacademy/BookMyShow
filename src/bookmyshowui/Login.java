...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ...
            String retreivedLoginRecord = "SELECT * FROM [User] WHERE UserName='"+userName+"' AND [Password]='"+password+"'";
            ResultSet myRs = stmt.executeQuery(retreivedLoginRecord);
            while(myRs.next())
            {
                if(myRs.getString("UserName") != null && myRs.getString("Password") != null)
                {
                    Login l = new Login();
                    Home hm = new Home();
                    hm.jButton3.setVisible(false);
                    hm.jButton4.setVisible(false);
                    hm.LoggedInUserName.setText("Hello! " + myRs.getString("UserName"));
                    hm.LogOff.setVisible(true);
                    hm.jButton1.setVisible(true);
                    l.dispose();
                    hm.setVisible(true);
                    break;
                }
